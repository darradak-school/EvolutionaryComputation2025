...
class LocalSearch:
    ...
    # Run the local search algorithm until no better neighbour is found, tracks cycles taken
    def local_search(self, tour, search_type, search_method, tsp):
        cycles_taken = 0
        current_tour = tour
        while True:
            ...
            if best_neighbour == current_tour:
                return current_tour, cycles_taken
